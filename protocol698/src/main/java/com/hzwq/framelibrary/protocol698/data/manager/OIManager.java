...
public class OIManager {
    ...
    private final static String ENERGY =
            "0000\t1\t组合有功电能\t\t\n" +
                    "0010\t1\t正向有功电能\t\t\n" +
                    "0011\t1\tA相正向有功电能\t\t\n" +
                    "0012\t1\tB相正向有功电能\t\t\n" +
                    ...
                    "0503\t1\tC相关联电能\t\t\n";
    // 最大需量类
    private final static String MAXIMUM_DEMAND =
            "1010\t2\t正向有功最大需量\t\t\n" +
                    "1011\t2\tA相正向有功最大需量\t\t\n" +
                    "1012\t2\tB相正向有功最大需量\t\t\n" +
                    "1013\t2\tC相正向有功最大需量\t\t\n" +
    ...
    private final static String VARIABLE =
            "2000\t3\t电压\t\t\n" +
                    ...
                    "2506\t6\t（仪表）状态ST\t\t\n";
    // 事件类
    private final static String EVENT = "3000\t24\t电能表失压事件\t\t\n" +
            "3001\t24\t电能表欠压事件\t\t\n" +
            "3002\t24\t电能表过压事件\t\t\n" +
            "3003\t24\t电能表断相事件\t\t\n" +
            "3004\t24\t电能表失流事件\t\t\n" +
            ...
            "3320\t8\t新增上报事件列表\t\t\n";
    // 参变量类
    private final static String PARAMETER = "4000\t8\t日期时间\t\t\n" +
            "4001\t8\t通信地址\t\t\n" +
            "4002\t8\t表号\t\t\n" +
            "4003\t8\t客户编号\t\t\n" +
            "4004\t8\t设备地理位置\t\t\n" +
            ...
            "4800\t11\t电器设备集合\t\t\n";
    // 冻结类
    private final static String FREEZE =
            "5000\t9\t瞬时冻结\t\t\n" +
                    "5001\t9\t秒冻结\t\t\n" +
                    "5002\t9\t分钟冻结\t\t\n" +
                    "5003\t9\t小时冻结\t\t\n" +
                    ...
                    "5011\t9\t阶梯结算冻结\t\t\n";
    // 采集监控类
    private final static String ACQUISITION_MONITORING =
            "6000\t11\t采集档案配置表\t\t\n" +
                    "6001\t8\t采集档案配置单元\t\t\n" +
                    "6002\t11\t搜表\t\t\n" +
                    "6003\t8\t一个搜表结果\t\t\n" +
    ...
    private final static String CONTROL =
            "8000\t8\t远程控制\t\t\n" +
                    ...
                    "8110\t8\t电控定值\t\t\n";
    // 文件传输类
    private final static String FILE_TRANSFER = "" +
            "F000\t18\t文件分帧传输管理\t\t\n" +
            "F001\t18\t文件分块传输管理\t\t\n" +
            "F002\t18\t文件扩展传输管理\t\t\n";
    // ESAM 接口类
    private final static String ESAM_INTERFACE =
            "F100\t21\tESAM\t\t\n" +
                    "F101\t8\t安全模式参数\t\t\n";
    //  输入输出设备类
    private final static String IN_0UT_DEVICE =
            "F200\t22\tRS232\t\t\n" +
                    "F201\t22\tRS485\t\t\n" +
                    "F202\t22\t红外\t\t\n" +
                    "F203\t22\t开关量输入\t\t\n" +
    ...
    private final static String ALL =
            ENERGY + MAXIMUM_DEMAND + VARIABLE
                    + EVENT + PARAMETER + FREEZE
                    + ACQUISITION_MONITORING + COLLECTION + CONTROL
                    + FILE_TRANSFER + ESAM_INTERFACE + IN_0UT_DEVICE + DISPLAY;
